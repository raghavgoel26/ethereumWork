...
contract Registry{
    ...
    function getBillOfSupplyById(uint id) returns(string materialName, uint materialQuantity, string materialOrigin, string materialZipcode, shippedLocations materialShippedTo, materialStatusOptions materialStaus;    ){
        ...
        materialShippedTo = billsOfSupply[id].materialStaus 
	  }
